                            ...
                            <tbody className="whitespace-nowrap divide-y">
                                <tr>
                                    <td className="py-6 px-4">
                                        <div className="flex items-center gap-6 w-max">
                                            <div className="h-36 w-36 h-36 shrink-0">
                                                <img src='./media/images/image1.jpg' className="w-full h-full object-cover rounded" />
                                            </div>
                                            <div>
                                                <p className="text-md font-bold text-[#333]">Ephemeral Horizont</p>
                                    ...
                                    <td className="py-6 px-4">
                                        <div className="flex items-center gap-6 w-max">
                                            <div className="h-36 w-36 shrink-0">
                                                <img src='./media/images/image2.jpg' className="w-full h-full object-cover rounded" />
                                            </div>
                                            <div>
                                                <p className="text-md font-bold text-[#333]">Whispers of Time</p>
                                                <button type="button" className="mt-4 font-semibold text-red-400 text-sm">
                                                    Remove
                                                </button>
                                            </div>
                                ...
                                <tr>
                                    <td className="py-6 px-4">
                                        <div className="flex items-center gap-6 w-max">
                                            <div className="h-36 w-36 shrink-0">
                                                <img src='./media/images/image5.jpg' className="w-full h-full object-cover rounded" />
                                            </div>
                                            <div>
                                                <p className="text-md font-bold text-[#333]">Ephemeral Horizon</p>
                                                <button type="button" className="mt-4 font-semibold text-red-400 text-sm">
                                                    Remove
                                                </button>
                                            </div>
