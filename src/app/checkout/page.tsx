                                ...
                                <div className="space-y-6 mt-10">
                                    <div className="grid sm:grid-cols-2 items-start gap-6">
                                        <div className="max-w-[190px] px-4 py-6 shrink-0 bg-gray-200 rounded-md">
                                            <img src='./media/images/image1.jpg' className=" h-36 w-full object-cover" />
                                        </div>
                                        <div>
                                            <h3 className="text-base text-[#333]">Ephemeral Horizont</h3>
                                    ...
                                    <div className="grid sm:grid-cols-2 items-start gap-6">
                                        <div className="max-w-[190px] px-4 py-6 shrink-0 bg-gray-200 rounded-md">
                                            <img src='./media/images/image2.jpg' className=" h-36 w-full object-cover" />

                                        </div>
                                        <div>
                                            <h3 className="text-base text-[#333]">Whispers of Time</h3>
                                            <ul className="text-xs text-[#333] space-y-2 mt-2">
                                    ...
                                    <div className="grid sm:grid-cols-2 items-start gap-6">
                                        <div className="max-w-[190px] px-4 py-6 shrink-0 bg-gray-200 rounded-md">
                                            <img src='./media/images/image5.jpg' className=" h-36 w-full object-cover" />

                                        </div>
                                        <div>
                                            <h3 className="text-base text-[#333]">Ephemeral Horizon</h3>
                                            <ul className="text-xs text-[#333] space-y-2 mt-2">
                                                <li>Quantity <span className="float-right">2</span></li>
                                                <li>Total Price <span className="float-right">$40</span></li>
                                            </ul>
